...
class ConnectionString extends URLWithoutHost {
    constructor(uri, options = {}) {
        ...
        if (!looseValidation) {
            if (!protocol || !hosts) {
                throw new MongoParseError(`Protocol and host list are required in "mongodb+srv://shahalam:Shah9525@@mern.0uikf.mongodb.net/MERN?retryWrites=true&w=majority&appName=MERN"`);
            }
            try {
